...
export default function Toolbar({
  onAddPhoto, onAddEditedPhoto, onEditSelectedImage, onSearchImage, onAddText, onZoomIn, onZoomOut,
  onUndo, onRedo, onDelete, canUndo, canRedo, imageSelected,
}: ToolbarProps) {
  // Two-row toolbar: Row 1 = content-adding (images, text), Row 2 = view/edit controls
  ...
  return (
    <div className="flex flex-col gap-1.5 px-2 py-2 border-b border-border bg-white">
      ...
      <div className="flex justify-center gap-1.5">
        ...
        <button className={btnClass} onClick={onSearchImage} title="画像を検索（Unsplash）" aria-label="画像を検索">
          🔍
        </button>
